...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="light.svg">
    <img src="dark.svg" alt="Muhammad Hanif Hawari - Creative Engineer" width="100%">
  </picture>
</p>
